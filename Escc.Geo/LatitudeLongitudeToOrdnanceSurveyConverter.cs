...
*  Source: http://read.pudn.com/downloads136/sourcecode/embed/581566/GPSPet%200505/NMEA2OSG.cs__.htm   *
*  March 2006                                                                                          * 
*                                                                                                      *  
...
{
    /// <summary>
    /// Convert Ordnance Survey easting and northing coordinates to WGS84 latidudes and longitudes
    /// </summary>
    public class LatitudeLongitudeToOrdnanceSurveyConverter
    {
        private static double deg2rad = Math.PI / 180;
        private static double rad2deg = 180.0 / Math.PI;
        
        /// <summary>
        /// Converts WGS84 lat and lon in NMEA form  eg 52?9.1461"N         002?3.3717"W 
        /// </summary>
        /// <param name="latitude">The nlat.</param>
        /// <param name="longitude">The nlon.</param>
        /// <param name="height">The height.</param>
        /// <returns></returns>
        public OrdnanceSurveyCoordinate ConvertLatitudeLongitudeToOrdnanceSurvey(string latitude, string longitude, double height)
        {
            //grab the bit up to the ? 
            var deciLat = Convert.ToDouble(latitude.Substring(0, latitude.IndexOf("\"")));
            var deciLon = Convert.ToDouble(longitude.Substring(0, longitude.IndexOf("\"")));
            ...
            deciLon += (Convert.ToDouble(longitude.Substring(0, latitude.IndexOf("\"")))) / 60;
            ...
            return ConvertLatitudeLongitudeToOrdnanceSurvey(deciLat, deciLon, height);
        }

        /// <summary>
        /// Converts WGS84 lat and lon in decimal form with S and W as -ve 
        /// </summary>
        /// <param name="latitude">The latitude.</param>
        /// <param name="longitude">The longitude.</param>
        /// <param name="height">The height.</param>
        /// <returns></returns>
        public OrdnanceSurveyCoordinate ConvertLatitudeLongitudeToOrdnanceSurvey(double latitude, double longitude, double height)
        {
            //first off convert to radians 
            double radWGlat = latitude * deg2rad;                                                            //   ? 
            double radWGlon = longitude * deg2rad;
        ...
        private OrdnanceSurveyCoordinate LLtoNE(double lat, double lon)
        {
            ...
            return new OrdnanceSurveyCoordinate()
            {
                Easting = east,
                Northing = north,
                GridReference = NE2NGR(east, north)
            };
        }
